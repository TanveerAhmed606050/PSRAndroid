...
object Constant {
    ...
    //    const val MEDIA_BASE_URL = "https://backend.scraperate.com/public/storage/"
    const val MEDIA_BASE_URL = "https://backend.scraperate.com/"
    ...
    const val FOOD_DISLIKES = "food_dislikes"
    const val TYPE = "type"
    const val SHARE_PREF = "MyPrefs"
