...
fun PSRBottomNavigationBar(
    ...
    NavigationBar(
        ...
        bottomMenuList.forEach { psrBottomDestination ->
            NavigationBarItem(
                selected = selectedDestination == psrBottomDestination.route,
                onClick = { navigateToTopLevelDestination(psrBottomDestination) },
                icon = {
                    Icon(
                        painter = painterResource(id = psrBottomDestination.icon),
                        contentDescription = "",
                        modifier = Modifier.size(24.dp)
                    )
                },
                label = {
                    Text(
                        text = psrBottomDestination.name,
                        fontSize = 12.sp,
                        fontFamily = regularFont,
                        lineHeight = 2.sp,
